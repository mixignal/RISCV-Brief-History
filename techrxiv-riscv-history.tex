...
RISC-V continues to evolve, with the 2023 ratification of new specifications including RISC-V Profiles, Cryptography Extensions Volume II, and the IOMMU Architecture Specification.
...
Intel's announcement of \$1 billion fund to support RISC-V chip development highlights its rising significance. RISC-V chips are now being used in devices such as earbuds, hard drives, and AI processors, with over 10 billion cores shipped. Companies are also considering RISC-V for data centers and spacecraft.
...
The Roma laptop, the first designed for RISC-V development, features a quad-core 1.5GHz 64-bit CPU, a dual-core GPU, 8GB RAM, 128GB eMMC storage, and a 1TB SSD. It runs on the multilingual openKylin OS, aimed at aiding developers in creating RISC-V software, signifying a significant advancement in the RISC-V ecosystem.
